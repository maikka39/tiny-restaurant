                ...
                @foreach($projects as $project)
                    <div class="timeline-item">
                        <figure class="image timeline-image">
                            @php($image = $project->imageAsArray('cover', 'flexible'))
                            <img src="{{ $image ? $image['src'] : asset('img/news-placeholder.png') }}" alt="{{ $image ? $image['alt'] : 'news placeholder' }}">
                        </figure>
                        <div class="timeline-marker"></div>
                        <div class="timeline-content">
                            <div class="timeline-content-wrapper">
                                <small class="is-size-7 mb-2">{{ $project->getCreatedTimeForView() }}</small>
                                <p class="is-size-4 has-text-weight-bold mb-5">{{ $project->title }}</p>
